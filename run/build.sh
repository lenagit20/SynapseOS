...
SRC="src"
OBJS="bin/kasm.o bin/irq_wrappers.o bin/kc.o bin/gdt.o bin/time.o bin/shell.o bin/idt.o bin/kbd.o bin/pic.o bin/tty.o bin/ports.o bin/qemu_log.o bin/cpu_detect.o bin/kheap.o bin/virt_mem.o bin/phys_mem.o bin/stdlib.o"
